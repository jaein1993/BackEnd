...
//	   }//register
	   ...
	   //----------------------------
	   @PostMapping("/modify")
	   public String modify(BoardDTO dto,Criteria cri,RedirectAttributes rttrs) throws ControllerException{
	   ...
	   @PostMapping("/remove")
	   public String remove(BoardDTO dto,Criteria cri,RedirectAttributes rttrs) throws ControllerException{
		   log.trace("remove ({},{}}",dto,cri);
...
//				   @RequestParam("bno")Integer BNO,
				   BoardDTO dto, 
				   @ModelAttribute("cri")Criteria cri,  //페이징처리때문에 추가한코드
				   
				   Model model
				   ) throws ControllerException{
			   
			   log.trace("get({},{},{}) invoked", dto,cri,model);
